...
if __name__ == '__main__':
    print [i for i in syllabify('avautuu')]                    # 1
    print [i for i in syllabify('rakkaus')]             # 1
    print [i for i in syllabify('rakkauden')]                    # 1
    print [i for i in syllabify('laukausta')]
    # print [i for i in syllabify('rakkaus')]                    # 1
    # print [i for i in syllabify('rakkaukakaus')]             # 1
    # print [i for i in syllabify('rakkauskakaus')]            # 2
    # print [i for i in syllabify('rakkauskakausrakkaus')]   # 3
    # print [i for i in syllabify('rakkaus')]                # 0
    # print [i for i in syllabify('rakkau')]                # 1
    # print [i for i in syllabify('rakkaukau')]          # 2
    pass
